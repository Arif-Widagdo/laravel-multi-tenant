                ...
                <div class="flex flex-col p-6 text-gray-900 gap-y-2">
                    <form method="POST" action="{{ route('tenants.update', $tenant) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block w-full mt-1" type="text" name="name" :value="old('name', $tenant->name)" required autofocus autocomplete="name" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="email" class="block w-full mt-1" type="email" name="email" :value="old('email', $tenant->email)" required autocomplete="username" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="domain_name" class="block w-full mt-1" type="text" name="domain_name" :value="old('domain_name', Str::replace('.'.config('app.domain'), '', $tenant->domains->first()->domain ?? ''))" required />
